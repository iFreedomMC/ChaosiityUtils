...
public class Command_information extends BukkitCommand<ScuphUtils> {
    ...
    public boolean run(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        ...
        sender.sendMessage(ChatColor.RED + "The server's current forums are " + plugin.getConfig().getString("server.website"));
        sender.sendMessage(ChatColor.DARK_GREEN + "iFreedomManagement was made by Camzie99 and Chaosiity");
        sender.sendMessage(ChatColor.BLUE + "The server's owner is " + plugin.getConfig().getString("server.owner") + "!");
        return true;
    }
